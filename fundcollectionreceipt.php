	...
	<thead>
		...
		<tr>
			<th style="text-align: left;">
				...
				<br>
				<b>Payment type: <?php echo $rsfund_collection['payment_type']; ?></b><br>
				<?php
				$payment_details = unserialize($rsfund_collection['payment_detail']);
				if (is_array($payment_details)) {
					echo "Card Holder: " . htmlspecialchars($payment_details[0]) . "<br>";
					echo "Card Number: **** **** **** " . substr($payment_details[1], -4) . "<br>";
					echo "Expiry Date: " . htmlspecialchars($payment_details[2]) . "<br>";
				}
				?>
			</th>
			<th style="text-align: right;" valign="top">
				RM<?php echo $rsfund_collection['paid_amt']; ?>
			</th>
		</tr>
	</thead>
</table>
